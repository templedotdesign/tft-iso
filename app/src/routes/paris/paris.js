  ...
  render() {
    return (
      <div className={classes.paris}>
        <h1 style={{color: '#2376ec'}}>Paris, 2018</h1>
        <hr/>
        ...
        <div style={{width: '50%', margin: '30px auto'}}>
          ...
          <h4 style={{textAlign: 'center'}}>July 14-21, 2018</h4>
          <h4 style={{textAlign: 'center'}}>8 Day River Cruise Paris-Paris Itinerary</h4>
        </div>
        <p>
        ...
        <div style={{padding: '30px 0'}}>
          <div className={classes.buttons}>
            <p style={{textAlign: 'center', color: 'white'}}>Ready To See Paris?</p>
            <div className={classes.row}>
              <a className={classes.button} href='http://www.emailmeform.com/builder/form/4ta9mWil5qQds1b8' target='_blank' rel='noopener noreferrer'>Reservation Request</a>
            </div>
          </div>
        </div>
        <div style={{width: '50%', margin: '30px auto'}}>
          <img src={parisImage} alt='paris'/>
          <h4 style={{textAlign: 'center'}}>Go for the Sights</h4>
        </div>
        <p>
        ...
        <div style={{width: '50%', margin: '30px auto'}}>
          <img src={mapImage} alt='cruise map'/>
